"""
Django settings for proartist_backend project.
...
SECRET_KEY = 'django-insecure-pf%zf=)p(2j%2ewgubgg0o2)u*w(06yo*h#2%y^xlv877!$x%#'
...
ROOT_URLCONF = 'proartist_backend.urls'
...
WSGI_APPLICATION = 'proartist_backend.wsgi.application'
